...
desired_X0 = {
    'wind': [
        np.array([ 1.27750843e+01,  1.04270725e+01, -5.01403771e-01, -3.48692268e-02,  5.90533519e-02, -3.22418226e-02]),
...
desired_modes = {
    'unloaded': [
    np.array([[-9.99999802e-01, -3.57616645e-14, -5.47524732e-08, -4.39978916e-13, -9.90311437e-01, -2.35696031e-15],
              [-2.08399263e-20,  9.99999800e-01, -7.45991192e-17,  9.90300308e-01, -1.02416914e-14, -1.13370282e-01],
              [ 1.27034965e-06,  1.15353690e-18, -1.00000000e+00, -5.06549551e-16, -3.61024872e-05,  2.33003918e-20],
              [-1.92236312e-20,  6.27336513e-04,  2.23948424e-18, -1.38943513e-01,  1.44183788e-15, -1.78996143e-04],
              [ 6.30061473e-04,  2.28388993e-17,  1.61898091e-07, -6.16938911e-14, -1.38864162e-01,  3.49024231e-17],
              [ 3.40207750e-20, -8.15805381e-05,  4.18603450e-18,  1.97802394e-05, -7.70378430e-18, -9.93552790e-01]]),
    np.array([[ 9.99999999e-01, -3.73868419e-10, -3.65779712e-10, -1.36407897e-13,  9.99898193e-01, -3.09303021e-13],
              [ 8.16487094e-10, -9.99999999e-01,  7.93317408e-17,  9.99898194e-01,  4.27029879e-14,  2.06096172e-03],
              [ 7.45752599e-11, -2.83822636e-18,  1.00000000e+00, -2.55906063e-18,  2.31375454e-10,  3.66904672e-16],
              [ 4.41436373e-14, -5.40653002e-05, -1.02490922e-18, -1.42689340e-02, -5.67371222e-16, -2.94481141e-05],
              [-5.40646648e-05,  2.02128603e-14, -4.68541454e-12, -1.94569886e-15,  1.42689404e-02,  1.77859343e-16],
              [ 4.56194444e-18, -5.58669353e-09, -9.42466222e-19,  4.97628953e-06, -9.78316493e-19, -9.99997876e-01]]),
...
def test_analyzeCases(index_and_model, plotPSDs=False):
    ...
    flagSaveValues = True # Set this flag to true to replace the true values file with the calculated values
